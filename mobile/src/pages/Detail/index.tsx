  ...
  return (
    <SafeAreaView style={{flex:1}}> 
      <View style={styles.container}>
        ...
        <Image style={styles.pointImage} source={{uri: 'https://i.pinimg.com/236x/ca/76/0b/ca760b70976b52578da88e06973af542.jpg'}}/>
        <Text style={styles.pointName}>Mercadão</Text>
        <Text style={styles.pointItems}>Lampadas oleo de cozinha</Text>

        <View style={styles.address}>
          <Text style={styles.addressTitle}>Endereço</Text>
          <Text style={styles.addressContent}>RIo do cul</Text>
        </View>
